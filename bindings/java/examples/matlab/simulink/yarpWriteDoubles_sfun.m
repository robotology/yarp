...
% SPDX-FileCopyrightText: 2012 Juan G. Victores
...
if yarp.Network.connect('/yarpWriteDoubles','/read')  % autoconnect just for testing
    disp '[success] port connected to /read';
else
    disp '[warning] port NOT connected to /read, does it exist?';
end
