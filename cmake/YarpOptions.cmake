...
option(CREATE_SHARED_LIBRARY "Compile shared libraries rather than linking statically" ON)
if(WIN32)
...
option(YARP_CLEAN_API "Filter out non-public symbols" OFF)
...
### -Werror
if(CXX_HAS_WERROR)
  option(YARP_ABORT_ON_WARNING "Consider compiler warnings as errors and abort compilation (-Werror)." ON)
