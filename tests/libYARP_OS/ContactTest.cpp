...
TEST_CASE("OS::ContactTest", "[yarp::os]") {
    ...
    {
        {
            INFO( "checking constructor with no parameters");
            Contact c;
            CHECK_FALSE(c.isValid()); // invalid Contact
        }

        {
            INFO("checking constructor with 1 parameter (name)");
            Contact c("/foo");
        ...
        {
            INFO("checking constructor with 2 parameters (name, carrier)");
            Contact c("/foo", "ziggy");
            CHECK_FALSE(c.isValid()); // not a valid Contact
            CHECK(c.getHost() == ""); // hostname not set
            CHECK(c.getPort() == -1); // port number not set
        ...
        {
            INFO("checking constructor with 3 parameters (name, carrier, hostname)");
        ...
        {
            INFO("checking constructor with 4 parameters (name, carrier, hostname, port)");
        ...
        {
            INFO("checking hostname/port constructor");
        ...
        {
            INFO("checking hostname/port constructor with portnumber = 0");
        ...
        {
            INFO("checking socket constructor");
        ...
        {
            INFO("checking socket constructor with portnumber = 0");
        ...
        {
            INFO("checking copy assignment operator with invalid Contact");
            Contact c1;
            Contact c2;
            c1 = c2;
...

        {
            ...
            INFO("checking copy assignment operator with valid Contact");
            c1 = c2;
        ...
        {
            INFO("checking copy constructor");
        ...
        {
            INFO("checking move constructor");
            Contact c1("www.robotology.yarp", 8080);
        ...
        {
            INFO("checking move assignment operator");
            Contact c;
        ...
        {
            INFO("checking Contact wrapper on regular url");
        ...
        {
            INFO("checking Contact wrapper on regular url without portnumber");
        ...
        {
            INFO("checking Contact wrapper on minimal url");
        ...
        {
            INFO("checking Contact wrapper on url without host");
            Contact c = Contact::fromString("ziggy:/my/url");
            CHECK_FALSE(c.isValid()); // valid Contact
            CHECK(c.getCarrier() == "ziggy"); // good carrier
            CHECK(c.getName() == "/my/url"); // good port name
        ...
        {
            INFO( "checking Contact wrapper on short url");
