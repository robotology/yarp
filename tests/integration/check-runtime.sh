...
PLUGIN_FLAGS="-DYARP_COMPILE_DEVICE_PLUGINS=TRUE -DENABLE_yarpmod_fakebot=TRUE -DYARP_COMPILE_CARRIER_PLUGINS=TRUE -DENABLE_yarpcar_human_carrier=TRUE -DCREATE_GUIS=OFF"
