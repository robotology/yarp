...
* `yarp::dev::INavigation2D`. Added helper static methods: `yarp::dev::NavigationStatusEnumHelpers::statusToString()`, `yarp::dev::NavigationStatusEnumHelpers::stringToStatus()`
