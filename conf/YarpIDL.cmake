...
macro(yarp_idl_to_dir thrift_file output_dir file_list_dir)
  ...
  set(fileListName ${file_list_dir}/${include_prefix}/${thriftName}.txt)
  option(ALLOW_IDL_GENERATION "Allow YARP to (re)build IDL files as needed" FALSE)
  if (ALLOW_IDL_GENERATION OR NOT EXISTS ${fileListName})
    message(STATUS "Generating source files for Thrift file ${thrift_file}. Output directory: ${output_dir}. File list directory: ${file_list_dir}")
    find_program(YARPIDL_LOCATION yarpidl_thrift HINTS ${YARP_IDL_BINARY_HINT})
    make_directory(${dir})
    configure_file(${YARP_MODULE_PATH}/template/placeGeneratedThriftFiles.cmake.in ${dir}/place${thriftName}.cmake @ONLY)
    execute_process(COMMAND ${YARPIDL_LOCATION} -out ${dir} --gen yarp:include_prefix -I ${CMAKE_CURRENT_SOURCE_DIR} ${thrift_file}  COMMAND ${CMAKE_COMMAND} -P ${dir}/place${thriftName}.cmake WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR})
  endif()
endmacro()
