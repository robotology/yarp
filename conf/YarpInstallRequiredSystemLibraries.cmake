...
# paulfitz -- added SXS directory structure support
...
IF(MSVC)
  ...
  ENDIF(MSVC71)
  IF(MSVC80)
    FILE(GLOB __sxs_libs "${SYSTEMROOT}/WinSxS/x86_Microsoft.VC80.CRT_*")
    IF(__sxs_libs)
      FILE(TO_CMAKE_PATH "${__sxs_libs}" __sxs_libs2)
      SET(__install__libs
        "${__sxs_libs2}/msvcp80.dll"
        "${__sxs_libs2}/msvcr80.dll"
        )
    ELSE(__sxs_libs)
      SET(__install__libs
