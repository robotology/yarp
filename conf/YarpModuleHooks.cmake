...
#		  WRITE_FILE(${ADDER_H} "extern void add_${NAME}();" APPEND)
    SET_DIRECTORY_PROPERTIES(PROPERTIES ADDITIONAL_MAKE_CLEAN_FILES
				${CMAKE_CURRENT_BINARY_DIR}/add_${NAME}.cpp)
  ...
  SET(cleaners ${CMAKE_CURRENT_BINARY_DIR}/all_add_yarpdev.cpp)
 ...
 IF (MERGE_DEVICE_LIBS)
  ...
  _ADD_LIBRARY(${YARPY_DEV_LIB_NAME} ${YARPY_SRC_LIST0} ${CMAKE_CURRENT_BINARY_DIR}/all_add_yarpdev.cpp)
 ELSE (MERGE_DEVICE_LIBS)
  _ADD_LIBRARY(${YARPY_DEV_LIB_NAME} ${CMAKE_CURRENT_BINARY_DIR}/all_add_yarpdev.cpp)
  FOREACH(LIB ${YARPY_LIB_LIST0})
 ...
 CONFIGURE_FILE(${YARP_MODULE_PATH}/yarpdev_lib_main.cpp.in
     ${CMAKE_CURRENT_BINARY_DIR}/yarpdev_${YARPY_DEV_LIB_NAME}.cpp @ONLY  IMMEDIATE)
 _ADD_EXECUTABLE(yarpdev_${YARPY_DEV_LIB_NAME} ${CMAKE_CURRENT_BINARY_DIR}/yarpdev_${YARPY_DEV_LIB_NAME}.cpp)
 SET(cleaners ${cleaners} ${CMAKE_CURRENT_BINARY_DIR}/yarpdev_${YARPY_DEV_LIB_NAME}.cpp)
 SET_DIRECTORY_PROPERTIES(PROPERTIES ADDITIONAL_MAKE_CLEAN_FILES "${cleaners}")
