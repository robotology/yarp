...
MACRO(YARP_PREPARE_DEVICES)
  ...
  INSTALL(TARGETS ${YARPY_DEV_LIB_NAME} EXPORT YARP COMPONENT device DESTINATION lib)
  SET_PROPERTY(TARGET ${YARPY_DEV_LIB_NAME} PROPERTY COMPILE_FLAGS ${YARPY_DEF_LIST0})
  ...
  IF (COMPILING_ALL_YARP)
    SET(EXENAME yarpdev)
    SET(EXPNAME YARP)
    SET_PROPERTY(GLOBAL APPEND PROPERTY YARP_LIBS ${YARPY_DEV_LIB_NAME})
  ELSE (COMPILING_ALL_YARP)
    SET(EXENAME ${YARPY_DEV_LIB_NAME}dev)
    SET(EXPNAME ${YARPY_DEV_LIB_NAME})
  ENDIF (COMPILING_ALL_YARP)
  ...
  _ADD_EXECUTABLE(${EXENAME} ${YARPY_DEV_GEN}/yarpdev_${YARPY_DEV_LIB_NAME}.cpp)
  INSTALL(TARGETS ${EXENAME} EXPORT YARP COMPONENT utilities DESTINATION bin)

  SET(YARPY_DEV_LIB_DEP ${YARPY_DEV_LIB_NAME})
  _TARGET_LINK_LIBRARIES(${EXENAME} ${YARPY_DEV_LIB_DEP})
  ...
  EXPORT_LIBRARY_DEPENDENCIES(${CMAKE_BINARY_DIR}/${YARPY_DEV_LIB_NAME}DependenciesOld.cmake)
  IF (COMPILING_ALL_YARP)
    EXPORT(TARGETS ${YARPY_DEV_LIB_NAME} YARP_dev YARP_sig YARP_OS FILE ${CMAKE_BINARY_DIR}/${YARPY_DEV_LIB_NAME}Dependencies.cmake)
  ELSE (COMPILING_ALL_YARP)
    EXPORT(TARGETS ${YARPY_DEV_LIB_NAME} FILE ${CMAKE_BINARY_DIR}/${YARPY_DEV_LIB_NAME}Dependencies.cmake)
  ENDIF (COMPILING_ALL_YARP)
