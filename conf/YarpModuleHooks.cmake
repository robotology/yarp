...
MACRO(ADD_SUBDIRECTORY SUBDIR)
  IF (YARPY_DEVICES)
     ...
     #  MESSAGE(FATAL_ERROR "device directory ${SUBDIR} does not contain a CMakeLists.txt")
     #ENDIF (NOT EXISTS "${SUBIDR}/CMakeLists.txt")
...
MACRO(YARP_PREPARE_DEVICES)
 ...
 ELSE (COMPILING_ALL_YARP)
	...
	# MESSAGE("YarpModuleHooks: ${YARPY_DEV_LIB_DEP}")
