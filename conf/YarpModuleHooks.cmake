...
MACRO(YARP_PREPARE_DEVICES)
  ...
  #IF (COMMAND EXPORT)
    # EXPORT_LIBRARY_DEPENDENCIES doesn't work very well, use new 
    # mechanism if available. -- don't do this for now
    # EXPORT(TARGETS ${YARPY_DEV_LIB_NAME} YARP_dev YARP_sig YARP_OS FILE ${CMAKE_BINARY_DIR}/${YARPY_DEV_LIB_NAME}Export.cmake)
