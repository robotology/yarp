...
MACRO(YARP_PREPARE_DEVICES)
 ...
 _ADD_EXECUTABLE(test_${YARPY_DEV_LIB_NAME} ${YARPY_DEV_GEN}/yarpdev_${YARPY_DEV_LIB_NAME}.cpp)
 TARGET_LINK_LIBRARIES(test_${YARPY_DEV_LIB_NAME} ${YARPY_DEV_LIB_NAME})
