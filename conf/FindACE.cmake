...
IF (EXISTS ${ACE4YARP_DIR})
  SET(BUILTIN_ACE TRUE CACHE BOOL "compile ACE with YARP")
  SET(BUILTIN_ACE_SOURCE_DIR "${ACE4YARP_DIR}/src" CACHE STRING "compile ACE source with YARP" FORCE)
  SET(BUILTIN_ACE_INCLUDE_DIR "${ACE4YARP_DIR}/include" CACHE STRING "include ACE headers with YARP" FORCE)
ENDIF ()
