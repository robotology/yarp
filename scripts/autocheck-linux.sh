...
CMAKEOPTS="-DCREATE_GUIS:BOOL=TRUE -DCREATE_DEVICE_LIBRARY:BOOL=TRUE -DCREATE_DEVICE_TESTS:BOOL=TRUE -DENABLE_XSensMTx:BOOL=TRUE -DENABLE_dragonfly:BOOL=TRUE -DENABLE_ffmpeg:BOOL=TRUE -DENABLE_opencv_grabber=TRUE -DENABLE_portaudio=TRUE -DENABLE_microphone=TRUE"
