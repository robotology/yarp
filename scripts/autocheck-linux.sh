...
(
echo "SET(EXTERNAM_MODULES iCub)"
echo "SET(iCub_PATH \"$PWD/../iCub\")"
...
CMAKEOPTS="-DCREATE_GUIS:BOOL=TRUE -DCREATE_DEVICE_LIBRARY_BUILTINS:BOOL=TRUE -DCREATE_BUILTIN_DEVICE_TESTS:BOOL=TRUE -DENABLE_ffmpeg:BOOL=TRUE -DENABLE_opencv_grabber:BOOL=TRUE -DENABLE_portaudio:BOOL=TRUE -DENABLE_microphone:BOOL=TRUE "
