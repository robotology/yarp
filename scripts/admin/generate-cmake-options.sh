...
#	;;
	*)
	CMAKE_OPTIONS="-DCREATE_YMANAGER:BOOL=TRUE -DCREATE_YMANAGER_GUI:BOOL=TRUE -DCREATE_GUIS:BOOL=TRUE -DCREATE_LIB_MATH:BOOL=TRUE -DENABLE_DASHBOARD_SUBMIT:BOOL=TRUE -DUSE_PORT_AUTHENTICATION:BOOL=TRUE"
esac
