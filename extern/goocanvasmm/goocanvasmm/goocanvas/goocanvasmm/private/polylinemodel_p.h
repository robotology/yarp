...
#ifndef _GOOCANVASMM_POLYLINEMODEL_P_H
#define _GOOCANVASMM_POLYLINEMODEL_P_H
...
class PolylineModel_Class : public Glib::Class
{
public:
...
#endif /* _GOOCANVASMM_POLYLINEMODEL_P_H */
