...
#include <goocanvasmm/private/enums_p.h>
...
// static
GType Glib::Value<Goocanvas::PointerEvents>::value_type()
{
  return goo_canvas_pointer_events_get_type();
}

// static
GType Glib::Value<Goocanvas::ItemVisibility>::value_type()
{
  return goo_canvas_item_visibility_get_type();
}

// static
GType Glib::Value<Goocanvas::PathCommandType>::value_type()
{
  return goo_canvas_path_command_type_get_type();
}
