...
#ifndef GTKDATABOXMM_WRAP_INIT_H_INCLUDED
#define GTKDATABOXMM_WRAP_INIT_H_INCLUDED

namespace GDatabox { void wrap_init(); }

#endif /* !GTKDATABOXMM_WRAP_INIT_H_INCLUDED */
