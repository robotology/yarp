...
{
public:
    TestDeviceWGP_ParamsParser();
    ~TestDeviceWGP_ParamsParser() override = default;

public:
    const std::string m_device_classname = {"TestDeviceWGP"};
    const std::string m_device_name = {"testDeviceWGP"};
