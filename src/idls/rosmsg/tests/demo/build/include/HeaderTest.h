...
// Generated from this HeaderTest.msg definition:
//   Header header
//   string[]  name
//   float64[] position
//   float64[] velocity
...
#ifndef YARPMSG_TYPE_HeaderTest
#define YARPMSG_TYPE_HeaderTest
...
class HeaderTest : public yarp::os::idl::WirePortable {
public:
  Header header;
  ...
  typedef yarp::os::idl::BareStyle<HeaderTest> rosStyle;
  typedef yarp::os::idl::BottleStyle<HeaderTest> bottleStyle;
...
string frame_id";
  ...
  yarp::os::Type getType() {
    yarp::os::Type typ = yarp::os::Type::byName("HeaderTest","HeaderTest");
