...
FILE(STRINGS /opt/iit/src/yarp/src/idls/rosmsg/tests/demo/build/_yarp_idl_/SharedData_indexALL.txt index)
...
foreach(genFile ${index})
  ...
  if (${type} STREQUAL ".h")
    ...
    if (${inclFound} EQUAL -1)
      message(WARNING "${genFile} not found in SharedData dir!")
...
file(WRITE /opt/iit/src/yarp/src/idls/rosmsg/tests/demo/build/bits/SharedData_msg.cmake "## This is an automatically-generated file.\n## It could get re-generated if the ALLOW_IDL_GENERATION flag is on\n\nset(headers ${headers})\nset(sources ${sources})\n")
