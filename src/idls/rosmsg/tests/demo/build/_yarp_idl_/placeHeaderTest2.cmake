...
FILE(STRINGS /opt/iit/src/yarp/src/idls/rosmsg/tests/demo/build/_yarp_idl_/HeaderTest2_indexALL.txt index)
...
foreach(genFile ${index})
  ...
  if (${type} STREQUAL ".h")
    ...
    if (${inclFound} EQUAL -1)
      message(WARNING "${genFile} not found in HeaderTest2 dir!")
...
file(WRITE /opt/iit/src/yarp/src/idls/rosmsg/tests/demo/build/bits/HeaderTest2_srv.cmake "## This is an automatically-generated file.\n## It could get re-generated if the ALLOW_IDL_GENERATION flag is on\n\nset(headers ${headers})\nset(sources ${sources})\n")
