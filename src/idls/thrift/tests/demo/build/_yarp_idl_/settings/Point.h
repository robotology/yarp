...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_Point
#define YARP_THRIFT_GENERATOR_STRUCT_Point
...
public:
  ...
  // Copy constructor
  Point(const Point& __alt) : WirePortable(__alt)  {
    this->x = __alt.x;
    this->y = __alt.y;
  }

  // Assignment operator
  const Point& operator = (const Point& __alt) {
    this->x = __alt.x;
    this->y = __alt.y;
    return *this;
  }
...
public:
  ...
  typedef yarp::os::idl::Unwrapped<Point > unwrapped;
  ...
  public:
    ...
    bool edit(Point& obj, bool dirty = true) {
