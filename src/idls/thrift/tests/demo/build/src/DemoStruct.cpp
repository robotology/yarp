...
bool DemoStruct::read_x(yarp::os::idl::WireReader& reader) {
  if (!reader.readI32(x)) {
    x = 0;
  }
  return true;
}
bool DemoStruct::nested_read_x(yarp::os::idl::WireReader& reader) {
  if (!reader.readI32(x)) {
    x = 0;
  }
  return true;
}
bool DemoStruct::read_y(yarp::os::idl::WireReader& reader) {
  if (!reader.readI32(y)) {
    reader.fail();
    return false;
  }
...
bool DemoStruct::nested_read_y(yarp::os::idl::WireReader& reader) {
  if (!reader.readI32(y)) {
    reader.fail();
    return false;
  }
...
bool DemoStruct::read(yarp::os::idl::WireReader& reader) {
  if (!read_x(reader)) return false;
  if (!read_y(reader)) return false;
  return !reader.isError();
}

bool DemoStruct::read(yarp::os::ConnectionReader& connection) {
  yarp::os::idl::WireReader reader(connection);
  if (!reader.readListHeader(2)) return false;
  return read(reader);
}

bool DemoStruct::write_x(yarp::os::idl::WireWriter& writer) {
  if (!writer.writeI32(x)) return false;
  return true;
}
bool DemoStruct::nested_write_x(yarp::os::idl::WireWriter& writer) {
  if (!writer.writeI32(x)) return false;
  return true;
}
bool DemoStruct::write_y(yarp::os::idl::WireWriter& writer) {
  if (!writer.writeI32(y)) return false;
  return true;
}
bool DemoStruct::nested_write_y(yarp::os::idl::WireWriter& writer) {
  if (!writer.writeI32(y)) return false;
  return true;
}
bool DemoStruct::write(yarp::os::idl::WireWriter& writer) {
  if (!write_x(writer)) return false;
  if (!write_y(writer)) return false;
  return !writer.isError();
}

bool DemoStruct::write(yarp::os::ConnectionWriter& connection) {
  yarp::os::idl::WireWriter writer(connection);
  if (!writer.writeListHeader(2)) return false;
  return write(writer);
}
bool DemoStruct::Editor::write(yarp::os::ConnectionWriter& connection) {
...
bool DemoStruct::Editor::read(yarp::os::ConnectionReader& connection) {
  if (!isValid()) return false;
  yarp::os::idl::WireReader reader(connection);
  reader.expectAccept();
...
yarp::os::ConstString DemoStruct::toString() {
  yarp::os::Bottle b;
  b.read(*this);
  return b.toString();
}
