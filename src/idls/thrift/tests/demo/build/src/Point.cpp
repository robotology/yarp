...
bool Point::read_x(yarp::os::idl::WireReader& reader) {
  if (!reader.readI32(x)) {
    reader.fail();
    return false;
  }
...
bool Point::nested_read_x(yarp::os::idl::WireReader& reader) {
  if (!reader.readI32(x)) {
    reader.fail();
    return false;
  }
...
bool Point::read_y(yarp::os::idl::WireReader& reader) {
  if (!reader.readI32(y)) {
    reader.fail();
    return false;
  }
...
bool Point::nested_read_y(yarp::os::idl::WireReader& reader) {
  if (!reader.readI32(y)) {
    reader.fail();
    return false;
  }
...
bool Point::read(yarp::os::idl::WireReader& reader) {
  if (!read_x(reader)) return false;
  if (!read_y(reader)) return false;
  return !reader.isError();
}

bool Point::read(yarp::os::ConnectionReader& connection) {
  yarp::os::idl::WireReader reader(connection);
  if (!reader.readListHeader(2)) return false;
  return read(reader);
}

bool Point::write_x(yarp::os::idl::WireWriter& writer) {
  if (!writer.writeI32(x)) return false;
  return true;
}
bool Point::nested_write_x(yarp::os::idl::WireWriter& writer) {
  if (!writer.writeI32(x)) return false;
  return true;
}
bool Point::write_y(yarp::os::idl::WireWriter& writer) {
  if (!writer.writeI32(y)) return false;
  return true;
}
bool Point::nested_write_y(yarp::os::idl::WireWriter& writer) {
  if (!writer.writeI32(y)) return false;
  return true;
}
bool Point::write(yarp::os::idl::WireWriter& writer) {
  if (!write_x(writer)) return false;
  if (!write_y(writer)) return false;
  return !writer.isError();
}

bool Point::write(yarp::os::ConnectionWriter& connection) {
  yarp::os::idl::WireWriter writer(connection);
  if (!writer.writeListHeader(2)) return false;
  return write(writer);
}
bool Point::Editor::write(yarp::os::ConnectionWriter& connection) {
...
bool Point::Editor::read(yarp::os::ConnectionReader& connection) {
  if (!isValid()) return false;
  yarp::os::idl::WireReader reader(connection);
  reader.expectAccept();
...
yarp::os::ConstString Point::toString() {
  yarp::os::Bottle b;
  b.read(*this);
  return b.toString();
}
