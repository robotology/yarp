...
namespace guiPid2
{
    ...
    static GtkWidget *trq_posStictionDes = NULL;
    static GtkWidget *trq_negStictionDes = NULL;
    ...
    static GtkWidget *trq_posStictionEntry = NULL;
    static GtkWidget *trq_negStictionEntry = NULL;
