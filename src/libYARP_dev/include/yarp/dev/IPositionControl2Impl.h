...
public:
    ...
    virtual bool positionMove(const int n_joint, const int *joints, const double *refs) YARP_OVERRIDE;
    virtual bool positionMove(const double *refs) YARP_OVERRIDE;
    virtual bool relativeMove(int j, double delta) YARP_OVERRIDE;
    virtual bool relativeMove(const int n_joint, const int *joints, const double *deltas) YARP_OVERRIDE;
    virtual bool relativeMove(const double *deltas) YARP_OVERRIDE;
    virtual bool checkMotionDone(bool *flag) YARP_OVERRIDE;
    virtual bool checkMotionDone(const int n_joint, const int *joints, bool *flags) YARP_OVERRIDE;
    virtual bool checkMotionDone(int j, bool *flag) YARP_OVERRIDE;
    virtual bool setRefSpeed(int j, double sp) YARP_OVERRIDE;
    virtual bool setRefSpeeds(const int n_joint, const int *joints, const double *spds) YARP_OVERRIDE;
    ...
    virtual bool getRefSpeeds(const int n_joint, const int *joints, double *spds) YARP_OVERRIDE;
    ...
    virtual bool getTargetPosition(const int joint, double *ref) YARP_OVERRIDE;
    virtual bool getTargetPositions(double *refs) YARP_OVERRIDE;
    virtual bool getTargetPositions(const int n_joint, const int *joints, double *refs) YARP_OVERRIDE;
};
...
public:
    ...
    virtual bool positionMoveRaw(const int n_joint, const int *joints, const double *refs) YARP_OVERRIDE
    {return NOT_YET_IMPLEMENTED("positionMoveRaw");}
    ...
    virtual bool relativeMoveRaw(const int n_joint, const int *joints, const double *refs) YARP_OVERRIDE
    {return NOT_YET_IMPLEMENTED("relativeMoveRaw");}
    ...
    virtual bool checkMotionDoneRaw(const int n_joint, const int *joints, bool *flags) YARP_OVERRIDE
    {return NOT_YET_IMPLEMENTED("checkMotionDoneRaw");}
    ...
    virtual bool setRefSpeedsRaw(const int n_joint, const int *joints, const double *spds) YARP_OVERRIDE
    ...
    virtual bool getRefSpeedsRaw(const int n_joint, const int *joints, double *spds) YARP_OVERRIDE
    ...
    virtual bool getTargetPositionRaw(const int joint, double *ref) YARP_OVERRIDE
    {return NOT_YET_IMPLEMENTED("stopRaw");}

    virtual bool getTargetPositionsRaw(double *refs) YARP_OVERRIDE
    {return NOT_YET_IMPLEMENTED("stopRaw");}

    virtual bool getTargetPositionsRaw(const int n_joint, const int *joints, double *refs) YARP_OVERRIDE
    {return NOT_YET_IMPLEMENTED("stopRaw");}
};
