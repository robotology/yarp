        ...
        if (pTorques)
        {
            ...
            switch (pTorques->get(0).asInt())
            {
                ...
                case 4: // torso
                    ...
                    mSubdevices[mChan2Board[0]].setTorque(mChan2BAddr[0],pTorques->get(2).asDouble()); //torso yaw (respect gravity)
                    mSubdevices[mChan2Board[1]].setTorque(mChan2BAddr[1],pTorques->get(3).asDouble()); //torso roll (lateral movement)
                    mSubdevices[mChan2Board[2]].setTorque(mChan2BAddr[2],pTorques->get(1).asDouble()); //torso pitch (front-back movement)
//                    mSubdevices[mChan2Board[3]].setTorque(mChan2BAddr[3],0.0);
//                    mSubdevices[mChan2Board[4]].setTorque(mChan2BAddr[4],0.0);
//                    mSubdevices[mChan2Board[5]].setTorque(mChan2BAddr[5],0.0);
                break;
