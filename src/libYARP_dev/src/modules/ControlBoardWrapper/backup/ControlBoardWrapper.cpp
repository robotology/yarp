...
=======
        return p->iJntEnc->resetEncoder(off+base);
>>>>>>> 68ee11d... iMotorEncoders implemented in ControlBoardWrapper
    }
    return false;
}
...
=======
            ret=ret&&p->iJntEnc->resetEncoder(off+base);
>>>>>>> 68ee11d... iMotorEncoders implemented in ControlBoardWrapper
        }
        else
            ret=false;
...
=======
        return p->iJntEnc->setEncoder(off+base,val);
>>>>>>> 68ee11d... iMotorEncoders implemented in ControlBoardWrapper
    }
    return false;
}
...
=======
            ret=ret&&p->iJntEnc->setEncoder(off+base, vals[l]);
>>>>>>> 68ee11d... iMotorEncoders implemented in ControlBoardWrapper
        }
        else
            ret=false;
...
=======
        return p->iJntEnc->getEncoder(off+base, v);
>>>>>>> 68ee11d... iMotorEncoders implemented in ControlBoardWrapper
    }
    *v=0.0;
    return false;
...
=======
            ret=ret&&p->iJntEnc->getEncoder(off+base, encs+l);
>>>>>>> 68ee11d... iMotorEncoders implemented in ControlBoardWrapper
        }
        else
            ret=false;
...
=======
            ret=ret&&p->iJntEnc->getEncoderTimed(off+base, encs+l, t+l);
>>>>>>> 68ee11d... iMotorEncoders implemented in ControlBoardWrapper
        }
        else
            ret=false;
...
=======
        return p->iJntEnc->getEncoderTimed(off+base, v, t);
>>>>>>> 68ee11d... iMotorEncoders implemented in ControlBoardWrapper
    }
    *v=0.0;
    return false;
...
=======
        return p->iJntEnc->getEncoderSpeed(off+base, sp);
>>>>>>> 68ee11d... iMotorEncoders implemented in ControlBoardWrapper
    }
    *sp=0.0;
    return false;
...
=======
            ret=ret&&p->iJntEnc->getEncoderSpeed(off+base, spds+l);
>>>>>>> 68ee11d... iMotorEncoders implemented in ControlBoardWrapper
        }
        else
            ret=false;
...
=======
        return p->iJntEnc->getEncoderAcceleration(off+base,acc);
>>>>>>> 68ee11d... iMotorEncoders implemented in ControlBoardWrapper
    }
    *acc=0.0;
    return false;
...
bool ControlBoardWrapper::getEncoderAccelerations(double *accs)
{
    ...
    for(int l=0;l<controlledJoints;l++)
    {
        ...
        if (p->iJntEnc)
        {
            ret=ret&&p->iJntEnc->getEncoderAcceleration(off+base, accs+l);
        }
        else
            ret=false;
    }
...
bool ControlBoardWrapper::resetMotorEncoder(int j) {
    int off=device.lut[j].offset;
    int subIndex=device.lut[j].deviceEntry;
    ...
    if (p->iMotEnc)
    {
        return p->iMotEnc->resetMotorEncoder(off+base);
    }
    return false;
}
...
=======
            ret=ret&&p->iMotEnc->resetMotorEncoder(off+base);
        }
        else
            ret=false;
    }
...
bool ControlBoardWrapper::setMotorEncoder(int j, double val) {
    int off=device.lut[j].offset;
    int subIndex=device.lut[j].deviceEntry;
    ...
    if (p->iMotEnc)
    {
        return p->iMotEnc->setMotorEncoder(off+base,val);
    }
    return false;
}
...
bool ControlBoardWrapper::setMotorEncoders(const double *vals) {
    ...
    for(int l=0;l<controlledJoints;l++)
    {
        ...
        if (p->iMotEnc)
        {
            ret=ret&&p->iMotEnc->setMotorEncoder(off+base, vals[l]);
        }
        else
            ret=false;
    }
...
bool ControlBoardWrapper::getMotorEncoder(int j, double *v) {
    int off=device.lut[j].offset;
    int subIndex=device.lut[j].deviceEntry;
    ...
    if (p->pos)
    {
        return p->iMotEnc->getMotorEncoder(off+base, v);
    }
    *v=0.0;
    return false;
}
...
bool ControlBoardWrapper::getMotorEncoders(double *encs) {
    ...
    for(int l=0;l<controlledJoints;l++)
    {
        ...
        if (p->iMotEnc)
        {
            ret=ret&&p->iMotEnc->getMotorEncoder(off+base, encs+l);
        }
        else
            ret=false;
    }
...
bool ControlBoardWrapper::getMotorEncodersTimed(double *encs, double *t) {
    ...
    for(int l=0;l<controlledJoints;l++)
    {
        ...
        if (p->iMotEnc)
        {
            ret=ret&&p->iMotEnc->getMotorEncoderTimed(off+base, encs+l, t+l);
        }
        else
            ret=false;
    }
...
bool ControlBoardWrapper::getMotorEncoderTimed(int j, double *v, double *t) {
    int off=device.lut[j].offset;
    int subIndex=device.lut[j].deviceEntry;
    ...
    if (p->iMotEnc)
    {
        return p->iMotEnc->getMotorEncoderTimed(off+base, v, t);
    }
    *v=0.0;
    return false;
}

bool ControlBoardWrapper::getMotorEncoderSpeed(int j, double *sp) {
    int off=device.lut[j].offset;
    int subIndex=device.lut[j].deviceEntry;
    ...
    if (p->iMotEnc)
    {
        return p->iMotEnc->getMotorEncoderSpeed(off+base, sp);
    }
    *sp=0.0;
    return false;
}
...
bool ControlBoardWrapper::getMotorEncoderSpeeds(double *spds) {
    ...
    for(int l=0;l<controlledJoints;l++)
    {
        ...
        if (p->iMotEnc)
        {
            ret=ret&&p->iMotEnc->getMotorEncoderSpeed(off+base, spds+l);
        }
        else
            ret=false;
    }
...
bool ControlBoardWrapper::getMotorEncoderAcceleration(int j, double *acc) {
    int off=device.lut[j].offset;
    int subIndex=device.lut[j].deviceEntry;
    ...
    if (p->iMotEnc)
    {
        return p->iMotEnc->getMotorEncoderAcceleration(off+base,acc);
    }
    *acc=0.0;
    return false;
}
...
bool ControlBoardWrapper::getMotorEncoderAccelerations(double *accs)
{
    ...
    for(int l=0;l<controlledJoints;l++)
    {
        ...
        if (p->iMotEnc)
        {
            ret=ret&&p->iMotEnc->getMotorEncoderAcceleration(off+base, accs+l);
>>>>>>> 68ee11d... iMotorEncoders implemented in ControlBoardWrapper
        }
        else
            ret=false;
