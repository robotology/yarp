...
//
// $Id: MEIMotionControl.h,v 1.2 2007-06-12 14:45:47 eshuy Exp $
//
//
...
#define MEI_WINNT
#define PCDSP_LIB
#include "../../winnt/dd_orig/include/pcdsp.h"
*/
...
public:
	BabyArmProperty() {
		fromString("(Joints	6)\
					...
					(Signs 0 0 0 0 0 0)\
					(Stiff 0 0 0 1 1 1)\
					(Max  30.0  50.0  40.0  90.0  70.0  40.0)\
					(Min -20.0 -30.0 -40.0 -90.0 -90.0 -270.0)\
					(Enable	1 1 1 0 0 0)\
					(Learn 0)\
					(Rate 40)\
					(TrajSteps	50)\
...
/*
					(HPid0 -310 -1500 0 0 -100 32767 0 32767 0 -30)\
					(HPid1 -270 -500  0 0 -100 32767 0 32767 0 0)\
					(HPid2 -290 -700  0 0 -150 32767 0 32767 0 -100)\
					(HPid3 -320 -600  0 0   0  32767 0 32767 0 0)\
					(HPid4 -300 -900  0 0 -100 32767 0 32767 0 -100)\
					(HPid5 -300 -600  0 0 -100 32767 0 32767 0 0)\

					(LPid0	-10.0  0.0 0.0 0.0 0.0 32767.0 0.0 32767.0 0.0 0.0)\
					(LPid1	-6.0 0.0 0.0 0.0 0.0 32767.0 0.0 32767.0 0.0 0.0)\
					(LPid2	-6.0 0.0 0.0 0.0 0.0 32767.0 0.0 32767.0 0.0 0.0)\
					(LPid3	-320.0 0.0 0.0 0.0 0.0 32767.0 0.0 32767.0 0.0 0.0)\
					(LPid4	-320.0 0.0 0.0 0.0 0.0 32767.0 0.0 32767.0 0.0 0.0)\
					(LPid5	-320.0 0.0 0.0 0.0 0.0 32767.0 0.0 32767.0 0.0 0.0)");*/
    };
} ;


// This namespace shows very prominently on the YARP documentation.
