...
#ifndef __PicoloDeviceDriverh__
#define __PicoloDeviceDriverh__
 ...
 */
class yarp::dev::PicoloDeviceDriver : public DeviceDriver, public IFrameGrabber, public IFrameGrabberRgb, public IFrameGrabberImage {
private:
...
public:
    ...
    /**
	 * Implements the FrameGrabberImage interface
	 */
