...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_JOINTSTATEDATA_H
#define YARP_THRIFT_GENERATOR_STRUCT_JOINTSTATEDATA_H
...
class YARP_dev_API JointStateData :
...
public:
    ...
    JointStateData(const yarp::sig::VectorOf<double>& jointPosition,
    ...
    typedef yarp::os::idl::Unwrapped<JointStateData> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_JOINTSTATEDATA_H
