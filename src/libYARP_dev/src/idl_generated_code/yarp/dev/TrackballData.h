...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_TRACKBALLDATA_H
#define YARP_THRIFT_GENERATOR_STRUCT_TRACKBALLDATA_H
...
class YARP_dev_API TrackballData :
...
public:
    ...
    // Default constructor
    TrackballData() = default;

    // Constructor with field values
    TrackballData(const double x,
                  const double y);
    ...
    typedef yarp::os::idl::Unwrapped<TrackballData> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_TRACKBALLDATA_H
