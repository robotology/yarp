...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_LLM_MESSAGEDATA_H
#define YARP_THRIFT_GENERATOR_STRUCT_LLM_MESSAGEDATA_H
...
class YARP_dev_API LLM_MessageData :
...
public:
    ...
    // Default constructor
    LLM_MessageData() = default;

    // Constructor with field values
    LLM_MessageData(const std::string& type,
    ...
    typedef yarp::os::idl::Unwrapped<LLM_MessageData> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_LLM_MESSAGEDATA_H
