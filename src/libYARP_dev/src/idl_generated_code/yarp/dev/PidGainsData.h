...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_PIDGAINSDATA_H
#define YARP_THRIFT_GENERATOR_STRUCT_PIDGAINSDATA_H
...
class YARP_dev_API PidGainsData :
...
public:
    ...
    // Default constructor
    PidGainsData() = default;

    // Constructor with field values
    PidGainsData(const double kp,
                 const double kd,
                 const double ki,
    ...
    typedef yarp::os::idl::Unwrapped<PidGainsData> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_PIDGAINSDATA_H
