...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_SENSORMEASUREMENTDATA_H
#define YARP_THRIFT_GENERATOR_STRUCT_SENSORMEASUREMENTDATA_H
...
class YARP_dev_API SensorMeasurementData :
...
public:
    ...
    // Default constructor
    SensorMeasurementData() = default;

    // Constructor with field values
    SensorMeasurementData(const yarp::sig::Vector& measurement,
    ...
    typedef yarp::os::idl::Unwrapped<SensorMeasurementData> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_SENSORMEASUREMENTDATA_H
