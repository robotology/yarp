...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_VERTEXDATA_H
#define YARP_THRIFT_GENERATOR_STRUCT_VERTEXDATA_H
...
public:
    ...
    VertexData(const std::int32_t x,
               const std::int32_t y);
    ...
    typedef yarp::os::idl::Unwrapped<VertexData> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_VERTEXDATA_H
