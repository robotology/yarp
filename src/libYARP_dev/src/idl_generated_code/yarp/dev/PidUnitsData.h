...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_PIDUNITSDATA_H
#define YARP_THRIFT_GENERATOR_STRUCT_PIDUNITSDATA_H
...
class YARP_dev_API PidUnitsData :
...
public:
    ...
    // Default constructor
    PidUnitsData() = default;

    // Constructor with field values
    PidUnitsData(const std::string& units_kp,
    ...
    typedef yarp::os::idl::Unwrapped<PidUnitsData> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_PIDUNITSDATA_H
