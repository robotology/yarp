...
std::string yarp::dev::NavigationStatusEnumHelpers::statusToString(yarp::dev::NavigationStatusEnum status)
{
...
yarp::dev::NavigationStatusEnum yarp::dev::NavigationStatusEnumHelpers::stringToStatus(std::string s)
{
