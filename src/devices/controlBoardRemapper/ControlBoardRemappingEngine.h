...
#ifndef YARP_DEV_CONTROLBOARDREMAPPING_ENGINE_H
#define YARP_DEV_CONTROLBOARDREMAPPING_ENGINE_H
...
class ControlBoardRemappingEngine :
...
protected:
    ...
    void setAxesNames(const std::vector<std::string>& axesNames);

public:
    ControlBoardRemappingEngine() = default;
    ControlBoardRemappingEngine(const ControlBoardRemappingEngine&) = delete;
    ControlBoardRemappingEngine(ControlBoardRemappingEngine&&) = delete;
    ControlBoardRemappingEngine& operator=(const ControlBoardRemappingEngine&) = delete;
    ControlBoardRemappingEngine& operator=(ControlBoardRemappingEngine&&) = delete;
    ~ControlBoardRemappingEngine() override = default;

    /**
    * Return the value of the verbose flag.
    * @return the verbose flag.
    */
    bool getVerbose() const { return _verb; }

    /**
    * Set the value of the verbose flag.
    */
    void setVerbose(bool v) { _verb = v; }

    bool detachAllDevices();
    bool attachAllDevices(const yarp::dev::PolyDriverList &l);
...
#endif // YARP_DEV_CONTROLBOARDREMAPPING_ENGINE_H
