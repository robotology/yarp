...
* \code{.unparsed}
* yarpdev --device opencv_writer --filename output.avi --framerate 30 --width 0 --height 0
* \endcode
*
* \code{.unparsed}
* yarpdev --device opencv_writer
* \endcode
*
*/
...
public:
    ...
    const std::string m_device_name = {"opencv_writer"};
