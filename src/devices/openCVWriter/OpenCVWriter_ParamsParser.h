...
#define OPENCVWRITER_PARAMSPARSER_H
...
* \code{.unparsed}
* yarpdev --device openCVWriter --filename output.avi --framerate 30 --width 0 --height 0
* \endcode
*
* \code{.unparsed}
* yarpdev --device openCVWriter
* \endcode
*
*/

class OpenCVWriter_ParamsParser : public yarp::dev::IDeviceDriverParams
{
public:
