...
return_get_current_position1::Editor::Editor()
{
    group = 0;
    obj_owned = true;
    obj = new return_get_current_position1;
    dirty_flags(false);
    yarp().setOwner(*this);
}

// Editor: constructor with base class
return_get_current_position1::Editor::Editor(return_get_current_position1& obj)
{
    group = 0;
    obj_owned = false;
    edit(obj, false);
...
// Editor: edit
bool return_get_current_position1::Editor::edit(return_get_current_position1& obj, bool dirty)
{
    if (obj_owned) {
        delete this->obj;
    }
...
bool return_get_current_position1::Editor::isValid() const
{
    return obj != nullptr;
}

// Editor: state
return_get_current_position1& return_get_current_position1::Editor::state()
{
    return *obj;
}

// Editor: grouping begin
void return_get_current_position1::Editor::start_editing()
{
    group++;
}

// Editor: grouping end
void return_get_current_position1::Editor::stop_editing()
{
    group--;
    if (group == 0 && is_dirty) {
        communicate();
...
// Editor: ret setter
void return_get_current_position1::Editor::set_ret(const bool ret)
{
    will_set_ret();
    obj->ret = ret;
    mark_dirty_ret();
...
// Editor: ret getter
bool return_get_current_position1::Editor::get_ret() const
{
    return obj->ret;
}

// Editor: ret will_set
bool return_get_current_position1::Editor::will_set_ret()
{
    return true;
}

// Editor: ret did_set
bool return_get_current_position1::Editor::did_set_ret()
{
    return true;
}

// Editor: loc setter
void return_get_current_position1::Editor::set_loc(const yarp::dev::Nav2D::Map2DLocation& loc)
{
    will_set_loc();
    obj->loc = loc;
    mark_dirty_loc();
...
// Editor: loc getter
const yarp::dev::Nav2D::Map2DLocation& return_get_current_position1::Editor::get_loc() const
{
    return obj->loc;
}

// Editor: loc will_set
bool return_get_current_position1::Editor::will_set_loc()
{
    return true;
}

// Editor: loc did_set
bool return_get_current_position1::Editor::did_set_loc()
{
    return true;
}

// Editor: clean
void return_get_current_position1::Editor::clean()
{
    dirty_flags(false);
}

// Editor: read
bool return_get_current_position1::Editor::read(yarp::os::ConnectionReader& connection)
{
    if (!isValid()) {
        return false;
    }
...
// Editor: write
bool return_get_current_position1::Editor::write(yarp::os::ConnectionWriter& connection) const
{
    if (!isValid()) {
        return false;
    }
...
void return_get_current_position1::Editor::communicate()
{
    if (group != 0) {
        return;
    }
...
void return_get_current_position1::Editor::mark_dirty()
{
    is_dirty = true;
}

// Editor: ret mark_dirty
void return_get_current_position1::Editor::mark_dirty_ret()
{
    if (is_dirty_ret) {
        return;
    }
...
void return_get_current_position1::Editor::mark_dirty_loc()
{
    if (is_dirty_loc) {
        return;
    }
...
// Editor: dirty_flags
void return_get_current_position1::Editor::dirty_flags(bool flag)
{
    is_dirty = flag;
    is_dirty_ret = flag;
    is_dirty_loc = flag;
