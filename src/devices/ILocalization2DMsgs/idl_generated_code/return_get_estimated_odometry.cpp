...
return_get_estimated_odometry::Editor::Editor()
{
    group = 0;
    obj_owned = true;
    obj = new return_get_estimated_odometry;
    dirty_flags(false);
    yarp().setOwner(*this);
}

// Editor: constructor with base class
return_get_estimated_odometry::Editor::Editor(return_get_estimated_odometry& obj)
{
    group = 0;
    obj_owned = false;
    edit(obj, false);
...
// Editor: edit
bool return_get_estimated_odometry::Editor::edit(return_get_estimated_odometry& obj, bool dirty)
{
    if (obj_owned) {
        delete this->obj;
    }
...
bool return_get_estimated_odometry::Editor::isValid() const
{
    return obj != nullptr;
}

// Editor: state
return_get_estimated_odometry& return_get_estimated_odometry::Editor::state()
{
    return *obj;
}

// Editor: grouping begin
void return_get_estimated_odometry::Editor::start_editing()
{
    group++;
}

// Editor: grouping end
void return_get_estimated_odometry::Editor::stop_editing()
{
    group--;
    if (group == 0 && is_dirty) {
        communicate();
...
// Editor: ret setter
void return_get_estimated_odometry::Editor::set_ret(const bool ret)
{
    will_set_ret();
    obj->ret = ret;
    mark_dirty_ret();
...
// Editor: ret getter
bool return_get_estimated_odometry::Editor::get_ret() const
{
    return obj->ret;
}

// Editor: ret will_set
bool return_get_estimated_odometry::Editor::will_set_ret()
{
    return true;
}

// Editor: ret did_set
bool return_get_estimated_odometry::Editor::did_set_ret()
{
    return true;
}

// Editor: odom setter
void return_get_estimated_odometry::Editor::set_odom(const yarp::dev::OdometryData& odom)
{
    will_set_odom();
    obj->odom = odom;
    mark_dirty_odom();
...
// Editor: odom getter
const yarp::dev::OdometryData& return_get_estimated_odometry::Editor::get_odom() const
{
    return obj->odom;
}

// Editor: odom will_set
bool return_get_estimated_odometry::Editor::will_set_odom()
{
    return true;
}

// Editor: odom did_set
bool return_get_estimated_odometry::Editor::did_set_odom()
{
    return true;
}

// Editor: clean
void return_get_estimated_odometry::Editor::clean()
{
    dirty_flags(false);
}

// Editor: read
bool return_get_estimated_odometry::Editor::read(yarp::os::ConnectionReader& connection)
{
    if (!isValid()) {
        return false;
    }
...
// Editor: write
bool return_get_estimated_odometry::Editor::write(yarp::os::ConnectionWriter& connection) const
{
    if (!isValid()) {
        return false;
    }
...
void return_get_estimated_odometry::Editor::communicate()
{
    if (group != 0) {
        return;
    }
...
void return_get_estimated_odometry::Editor::mark_dirty()
{
    is_dirty = true;
}

// Editor: ret mark_dirty
void return_get_estimated_odometry::Editor::mark_dirty_ret()
{
    if (is_dirty_ret) {
        return;
    }
...
void return_get_estimated_odometry::Editor::mark_dirty_odom()
{
    if (is_dirty_odom) {
        return;
    }
...
// Editor: dirty_flags
void return_get_estimated_odometry::Editor::dirty_flags(bool flag)
{
    is_dirty = flag;
    is_dirty_ret = flag;
    is_dirty_odom = flag;
