...
namespace {
    YARP_LOG_COMPONENT(PortAudioPlayerDeviceDriverParamsCOMPONENT, "yarp.device.PortAudioPlayerDeviceDriver")
}
...
bool PortAudioPlayerDeviceDriver_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
...
std::string PortAudioPlayerDeviceDriver_ParamsParser::getConfiguration() const
{
...
bool      PortAudioPlayerDeviceDriver_ParamsParser::parseParams(const yarp::os::Searchable & config)
{
    //Check for --help option
    if (config.check("help"))
    {
        yCInfo(PortAudioPlayerDeviceDriverParamsCOMPONENT) << getDocumentationOfDeviceParams();
    }
    ...
    //Parser of parameter driver_frame_size
    {
        if (config.check("driver_frame_size"))
        {
            ...
            yCInfo(PortAudioPlayerDeviceDriverParamsCOMPONENT) << "Parameter 'driver_frame_size' using value:" << m_driver_frame_size;
        }
        else
        {
            yCInfo(PortAudioPlayerDeviceDriverParamsCOMPONENT) << "Parameter 'driver_frame_size' using DEFAULT value:" << m_driver_frame_size;
        }
    ...
    if (prop_check.size() > 0)
    {
        ...
        for (auto it=prop_check.begin(); it!=prop_check.end(); it++)
        {
            ...
            {
                yCError(PortAudioPlayerDeviceDriverParamsCOMPONENT) << "User asking for parameter: "<<it->name <<" which is unknown to this parser!";
                extra_params_found = true;
            }
            else
            {
                yCWarning(PortAudioPlayerDeviceDriverParamsCOMPONENT) << "User asking for parameter: "<< it->name <<" which is unknown to this parser!";
            }
        }
...
std::string      PortAudioPlayerDeviceDriver_ParamsParser::getDocumentationOfDeviceParams() const
{
    std::string doc;
    doc = doc + std::string("\n=============================================\n");
