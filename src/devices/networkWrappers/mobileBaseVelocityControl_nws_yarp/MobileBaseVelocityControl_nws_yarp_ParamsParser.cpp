...
bool MobileBaseVelocityControl_nws_yarp_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    if (paramName =="local")
    {
        paramValue = m_local;
...
std::string MobileBaseVelocityControl_nws_yarp_ParamsParser::getConfiguration() const
{
