...
bool      RemoteControlBoard_ParamsParser::parseParams(const yarp::os::Searchable & config)
{
    ...
    //Parser of parameter use_streaming
    {
        if (config.check("use_streaming"))
        {
            ...
            yCInfo(RemoteControlBoardParamsCOMPONENT) << "Parameter 'use_streaming' using value:" << m_use_streaming;
        }
        else
        {
            yCInfo(RemoteControlBoardParamsCOMPONENT) << "Parameter 'use_streaming' using DEFAULT value:" << m_use_streaming;
        }
...
std::string      RemoteControlBoard_ParamsParser::getDocumentationOfDeviceParams() const
{
    ...
    doc = doc + " yarpdev --device remote_controlboard --remote <mandatory_value> --local <mandatory_value> --writeStrict <optional_value> --carrier fast_tcp --carrier_cmd fast_tcp --timeout 0.5 --use_streaming true --local_qos::enable false --local_qos::thread_priority 0 --local_qos::thread_policy 0 --local_qos::packet_priority <optional_value> --remote_qos::enable false --remote_qos::thread_priority 0 --remote_qos::thread_policy 0 --remote_qos::packet_priority <optional_value> --diagnostic false\n";
