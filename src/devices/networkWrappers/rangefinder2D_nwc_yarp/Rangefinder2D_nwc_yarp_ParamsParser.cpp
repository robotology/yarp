...
bool Rangefinder2D_nwc_yarp_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    if (paramName =="local")
    {
        paramValue = m_local;
...
std::string Rangefinder2D_nwc_yarp_ParamsParser::getConfiguration() const
{
