...
#ifndef RANGEFINDER2D_NWC_YARP_PARAMSPARSER_H
#define RANGEFINDER2D_NWC_YARP_PARAMSPARSER_H
...
* \code{.unparsed}
* yarpdev --device rangefinder2D_nwc_yarp --local <mandatory_value> --remote <mandatory_value> --carrier tcp
* \endcode
*
* \code{.unparsed}
* yarpdev --device rangefinder2D_nwc_yarp --local <mandatory_value> --remote <mandatory_value>
* \endcode
*
*/

class Rangefinder2D_nwc_yarp_ParamsParser : public yarp::dev::IDeviceDriverParams
{
public:
