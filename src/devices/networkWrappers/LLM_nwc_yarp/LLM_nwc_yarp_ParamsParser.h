...
#ifndef LLM_NWC_YARP_PARAMSPARSER_H
...
* \code{.unparsed}
* yarpdev --device LLM_nwc_yarp --local <mandatory_value> --remote <mandatory_value>
* \endcode
*
* \code{.unparsed}
* yarpdev --device LLM_nwc_yarp --local <mandatory_value> --remote <mandatory_value>
...
class LLM_nwc_yarp_ParamsParser : public yarp::dev::IDeviceDriverParams
{
public:
