...
#ifndef MULTIPLEANALOGSENSORSSERVER_PARAMSPARSER_H
#define MULTIPLEANALOGSENSORSSERVER_PARAMSPARSER_H
...
class MultipleAnalogSensorsServer_ParamsParser : public yarp::dev::IDeviceDriverParams
{
public:
    MultipleAnalogSensorsServer_ParamsParser();
    ~MultipleAnalogSensorsServer_ParamsParser() override = default;

public:
    const std::string m_device_classname = {"MultipleAnalogSensorsServer"};
