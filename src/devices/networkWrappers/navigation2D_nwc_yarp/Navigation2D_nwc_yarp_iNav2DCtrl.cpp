...
ReturnValue Navigation2D_nwc_yarp::getNavigationStatus(NavigationStatusEnum& status)
{
...
ReturnValue   Navigation2D_nwc_yarp::getAllNavigationWaypoints(yarp::dev::Nav2D::TrajectoryTypeEnum trajectory_type, yarp::dev::Nav2D::Map2DPath& waypoints)
{
    std::lock_guard <std::mutex> lg(m_mutex);
