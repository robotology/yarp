...
#ifndef SPEECHSYNTHESIZER_NWC_YARP_PARAMSPARSER_H
#define SPEECHSYNTHESIZER_NWC_YARP_PARAMSPARSER_H
...
* \code{.unparsed}
* yarpdev --device speechSynthesizer_nwc_yarp --local <mandatory_value> --remote <mandatory_value>
* \endcode
*
* \code{.unparsed}
* yarpdev --device speechSynthesizer_nwc_yarp --local <mandatory_value> --remote <mandatory_value>
...
class SpeechSynthesizer_nwc_yarp_ParamsParser : public yarp::dev::IDeviceDriverParams
{
public:
