...
TEST_CASE("dev::robotDescriptionServerTest", "[yarp::dev]")
{
    ...
    SECTION("Test the RobotDescriptionServer device")
    {
        ...
        //some tests
        {
            DeviceDescription dev1;
            dev1.device_name = "/icubTest/left_arm";
            dev1.device_type = "controlBoard_nws_yarp";
            DeviceDescription dev2;
            dev2.device_name = "/icubTest/left_leg";
            dev2.device_type = "controlBoard_nws_yarp";
            DeviceDescription dev3;
            dev3.device_name = "/icubTest/test";
            dev3.device_type = "testDevice";
