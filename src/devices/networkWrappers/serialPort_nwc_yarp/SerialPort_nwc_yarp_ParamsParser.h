...
#ifndef SERIALPORT_NWC_YARP_PARAMSPARSER_H
#define SERIALPORT_NWC_YARP_PARAMSPARSER_H
...
* | -          | remote         | string | -     | -             | 1        | Full port name of the port opened on the server side, to which the device connects to. | -     |
*
* The device can be launched by yarpdev using one of the following examples (with and without all optional parameters):
* \code{.unparsed}
* yarpdev --device serialPort_nwc_yarp --local <mandatory_value> --remote <mandatory_value>
* \endcode
*
* \code{.unparsed}
* yarpdev --device serialPort_nwc_yarp --local <mandatory_value> --remote <mandatory_value>
...
class SerialPort_nwc_yarp_ParamsParser : public yarp::dev::IDeviceDriverParams
{
public:
