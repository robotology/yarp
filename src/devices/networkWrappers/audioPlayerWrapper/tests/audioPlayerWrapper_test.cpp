...
TEST_CASE("dev::audioPlayerWrapper", "[yarp::dev]")
{
    ...
    YARP_REQUIRE_PLUGIN("AudioPlayerWrapper", "device");

    Network::setLocalMode(true);

    SECTION("Test the audioPlayerWrapper device with a no device attached")
    {
        PolyDriver dd_nws;
        Property p_nws;
    ...
    SECTION("Test the audioPlayerWrapper device with a fakeSpeaker device")
    {
        PolyDriver dd_fake;
        PolyDriver dd_nws;
        Property p_fake;
