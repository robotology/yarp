...
return_get_all_nav_waypoints::Editor::Editor()
{
    group = 0;
    obj_owned = true;
    obj = new return_get_all_nav_waypoints;
    dirty_flags(false);
    yarp().setOwner(*this);
}

// Editor: constructor with base class
return_get_all_nav_waypoints::Editor::Editor(return_get_all_nav_waypoints& obj)
{
    group = 0;
    obj_owned = false;
    edit(obj, false);
...
// Editor: edit
bool return_get_all_nav_waypoints::Editor::edit(return_get_all_nav_waypoints& obj, bool dirty)
{
    if (obj_owned) {
        delete this->obj;
    }
...
bool return_get_all_nav_waypoints::Editor::isValid() const
{
    return obj != nullptr;
}

// Editor: state
return_get_all_nav_waypoints& return_get_all_nav_waypoints::Editor::state()
{
    return *obj;
}

// Editor: grouping begin
void return_get_all_nav_waypoints::Editor::start_editing()
{
    group++;
}

// Editor: grouping end
void return_get_all_nav_waypoints::Editor::stop_editing()
{
    group--;
    if (group == 0 && is_dirty) {
        communicate();
...
// Editor: ret setter
void return_get_all_nav_waypoints::Editor::set_ret(const bool ret)
{
    will_set_ret();
    obj->ret = ret;
    mark_dirty_ret();
...
// Editor: ret getter
bool return_get_all_nav_waypoints::Editor::get_ret() const
{
    return obj->ret;
}

// Editor: ret will_set
bool return_get_all_nav_waypoints::Editor::will_set_ret()
{
    return true;
}

// Editor: ret did_set
bool return_get_all_nav_waypoints::Editor::did_set_ret()
{
    return true;
}

// Editor: waypoints setter
void return_get_all_nav_waypoints::Editor::set_waypoints(const yarp::dev::Nav2D::Map2DPath& waypoints)
{
    will_set_waypoints();
...
const yarp::dev::Nav2D::Map2DPath& return_get_all_nav_waypoints::Editor::get_waypoints() const
{
    return obj->waypoints;
}

// Editor: waypoints will_set
bool return_get_all_nav_waypoints::Editor::will_set_waypoints()
{
    return true;
}

// Editor: waypoints did_set
bool return_get_all_nav_waypoints::Editor::did_set_waypoints()
{
    return true;
}

// Editor: clean
void return_get_all_nav_waypoints::Editor::clean()
{
    dirty_flags(false);
}

// Editor: read
bool return_get_all_nav_waypoints::Editor::read(yarp::os::ConnectionReader& connection)
{
    if (!isValid()) {
        return false;
    }
    ...
    if (tag == "help") {
        ...
        if (reader.getLength() > 0) {
            ...
            if (field == "waypoints") {
                ...
                if (!writer.writeString("yarp::dev::Nav2D::Map2DPath waypoints")) {
                    return false;
                }
            }
        }
...
// Editor: write
bool return_get_all_nav_waypoints::Editor::write(yarp::os::ConnectionWriter& connection) const
{
    if (!isValid()) {
        return false;
    }
...
void return_get_all_nav_waypoints::Editor::communicate()
{
    if (group != 0) {
        return;
    }
...
void return_get_all_nav_waypoints::Editor::mark_dirty()
{
    is_dirty = true;
}

// Editor: ret mark_dirty
void return_get_all_nav_waypoints::Editor::mark_dirty_ret()
{
    if (is_dirty_ret) {
        return;
    }
...
void return_get_all_nav_waypoints::Editor::mark_dirty_waypoints()
{
    if (is_dirty_waypoints) {
        return;
    }
...
// Editor: dirty_flags
void return_get_all_nav_waypoints::Editor::dirty_flags(bool flag)
{
    is_dirty = flag;
    is_dirty_ret = flag;
