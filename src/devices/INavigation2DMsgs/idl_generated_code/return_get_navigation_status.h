...
public:
    ...
    public:
        ...
        Editor(return_get_navigation_status& obj);
        ...
        // Editor: edit
        bool edit(return_get_navigation_status& obj, bool dirty = true);

        // Editor: validity check
        bool isValid() const;

        // Editor: state
        return_get_navigation_status& state();
        ...
        // Editor: status field
        void set_status(const yarp::dev::Nav2D::NavigationStatusEnum status);
        yarp::dev::Nav2D::NavigationStatusEnum get_status() const;
    ...
    private:
        // Editor: state
        return_get_navigation_status* obj;
        bool obj_owned;
        int group;
