...
namespace
{
    YARP_LOG_COMPONENT(SERVICE_LOG_COMPONENT, "FrameTransformStorageSetRPC")
}

//FrameTransformStorageSetRPC_getRemoteProtocolVersion_helper declaration
class FrameTransformStorageSetRPC_getRemoteProtocolVersion_helper :
public yarp::os::Portable
{
public:
    FrameTransformStorageSetRPC_getRemoteProtocolVersion_helper() = default;
...
bool FrameTransformStorageSetRPC_getRemoteProtocolVersion_helper::write(yarp::os::ConnectionWriter& connection) const
{
...
bool FrameTransformStorageSetRPC_getRemoteProtocolVersion_helper ::read(yarp::os::ConnectionReader & connection)
 {
...
yarp::os::ApplicationNetworkProtocolVersion FrameTransformStorageSetRPC::getRemoteProtocolVersion()
 {
    if(!yarp().canWrite()) {
        yError(" Missing server method FrameTransformStorageSetRPC::getRemoteProtocolVersion");
    }
    FrameTransformStorageSetRPC_getRemoteProtocolVersion_helper helper{};
...
//ProtocolVersion, client side
bool FrameTransformStorageSetRPC::checkProtocolVersion()
 {
...
yarp::os::ApplicationNetworkProtocolVersion FrameTransformStorageSetRPC::getLocalProtocolVersion()
{
