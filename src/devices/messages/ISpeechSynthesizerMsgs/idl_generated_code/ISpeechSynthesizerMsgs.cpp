...
namespace
{
    YARP_LOG_COMPONENT(SERVICE_LOG_COMPONENT, "ISpeechSynthesizerMsgs")
}

//ISpeechSynthesizerMsgs_getRemoteProtocolVersion_helper declaration
class ISpeechSynthesizerMsgs_getRemoteProtocolVersion_helper :
...
bool ISpeechSynthesizerMsgs_getRemoteProtocolVersion_helper::write(yarp::os::ConnectionWriter& connection) const
{
...
bool ISpeechSynthesizerMsgs_getRemoteProtocolVersion_helper ::read(yarp::os::ConnectionReader & connection)
 {
...
yarp::os::ApplicationNetworkProtocolVersion ISpeechSynthesizerMsgs::getRemoteProtocolVersion()
 {
    if(!yarp().canWrite()) {
        yError(" Missing server method ISpeechSynthesizerMsgs::getRemoteProtocolVersion");
    }
    ISpeechSynthesizerMsgs_getRemoteProtocolVersion_helper helper{};
