...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETRECORDINGAUDIOBUFFERCURRENTSIZE_H
#define YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETRECORDINGAUDIOBUFFERCURRENTSIZE_H
...
public:
    ...
    typedef yarp::os::idl::Unwrapped<return_getRecordingAudioBufferCurrentSize> unwrapped;
