...
namespace
{
    YARP_LOG_COMPONENT(SERVICE_LOG_COMPONENT, "IAudioGrabberMsgs")
}

//IAudioGrabberMsgs_getRemoteProtocolVersion_helper declaration
class IAudioGrabberMsgs_getRemoteProtocolVersion_helper :
...
bool IAudioGrabberMsgs_getRemoteProtocolVersion_helper::write(yarp::os::ConnectionWriter& connection) const
{
...
bool IAudioGrabberMsgs_getRemoteProtocolVersion_helper ::read(yarp::os::ConnectionReader & connection)
 {
...
yarp::os::ApplicationNetworkProtocolVersion IAudioGrabberMsgs::getRemoteProtocolVersion()
 {
    if(!yarp().canWrite()) {
        yError(" Missing server method IAudioGrabberMsgs::getRemoteProtocolVersion");
    }
    IAudioGrabberMsgs_getRemoteProtocolVersion_helper helper{};
...
//ProtocolVersion, client side
bool IAudioGrabberMsgs::checkProtocolVersion()
 {
...
yarp::os::ApplicationNetworkProtocolVersion IAudioGrabberMsgs::getLocalProtocolVersion()
{
