...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETAUTOBRAKEENABLED_H
#define YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETAUTOBRAKEENABLED_H

#include <yarp/os/Wire.h>
#include <yarp/os/idl/WireTypes.h>
#include <yarp/dev/ReturnValue.h>

class return_getAutoBrakeEnabled :
...
public:
    ...
    // Default constructor
    return_getAutoBrakeEnabled() = default;

    // Constructor with field values
    return_getAutoBrakeEnabled(const yarp::dev::ReturnValue& ret,
                               const bool enabled);
    ...
    typedef yarp::os::idl::Unwrapped<return_getAutoBrakeEnabled> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETAUTOBRAKEENABLED_H
