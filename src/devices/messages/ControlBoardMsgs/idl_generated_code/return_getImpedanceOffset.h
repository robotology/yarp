...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETIMPEDANCEOFFSET_H
#define YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETIMPEDANCEOFFSET_H

#include <yarp/os/Wire.h>
#include <yarp/os/idl/WireTypes.h>
#include <yarp/dev/ReturnValue.h>

class return_getImpedanceOffset :
...
public:
    ...
    // Default constructor
    return_getImpedanceOffset() = default;

    // Constructor with field values
    return_getImpedanceOffset(const yarp::dev::ReturnValue& ret,
                              const double offset);
    ...
    typedef yarp::os::idl::Unwrapped<return_getImpedanceOffset> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETIMPEDANCEOFFSET_H
