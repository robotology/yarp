...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETAXISNAME_H
#define YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETAXISNAME_H

#include <yarp/os/Wire.h>
#include <yarp/os/idl/WireTypes.h>
#include <yarp/dev/ReturnValue.h>

class return_getAxisName :
...
public:
    ...
    // Default constructor
    return_getAxisName() = default;

    // Constructor with field values
    return_getAxisName(const yarp::dev::ReturnValue& ret,
    ...
    typedef yarp::os::idl::Unwrapped<return_getAxisName> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETAXISNAME_H
