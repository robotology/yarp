...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETPIDOFFSET_H
#define YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETPIDOFFSET_H

#include <yarp/os/Wire.h>
#include <yarp/os/idl/WireTypes.h>
#include <yarp/dev/ReturnValue.h>

class return_getPidOffset :
...
public:
    ...
    // Default constructor
    return_getPidOffset() = default;

    // Constructor with field values
    return_getPidOffset(const yarp::dev::ReturnValue& ret,
                        const double offset);
    ...
    typedef yarp::os::idl::Unwrapped<return_getPidOffset> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETPIDOFFSET_H
