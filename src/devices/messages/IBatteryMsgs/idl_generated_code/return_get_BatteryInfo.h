...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_RETURN_GET_BATTERYINFO_H
#define YARP_THRIFT_GENERATOR_STRUCT_RETURN_GET_BATTERYINFO_H

#include <yarp/os/Wire.h>
#include <yarp/os/idl/WireTypes.h>
#include <yarp/dev/ReturnValue.h>

class return_get_BatteryInfo :
...
public:
    ...
    // Default constructor
    return_get_BatteryInfo() = default;

    // Constructor with field values
    return_get_BatteryInfo(const yarp::dev::ReturnValue& result,
    ...
    typedef yarp::os::idl::Unwrapped<return_get_BatteryInfo> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_RETURN_GET_BATTERYINFO_H
