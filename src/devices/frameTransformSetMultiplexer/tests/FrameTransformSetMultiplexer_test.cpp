...
TEST_CASE("dev::frameTransformSetMultiplexer", "[yarp::dev]")
{
    ...
    SECTION("test the frameTransformSetMultiplexer")
    {
        ...
        p_multi.put("device", "frameTransformSetMultiplexer");
