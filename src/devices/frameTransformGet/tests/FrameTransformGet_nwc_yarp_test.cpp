...
TEST_CASE("dev::frameTransformGet_nwc_yarp", "[yarp::dev]")
{
    ...
    YARP_REQUIRE_PLUGIN("frameTransformGet_nwc_yarp", "device");

    yarp::os::Network::setLocalMode(true);
    const bool verboseDebug = true;

    SECTION("test the frameTransformGet_nwc_yarp")
    {
        ...
        p_nwc.put("device", "frameTransformGet_nwc_yarp");
