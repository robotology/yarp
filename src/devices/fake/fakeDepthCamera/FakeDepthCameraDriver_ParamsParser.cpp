...
std::vector<std::string> FakeDepthCameraDriver_ParamsParser::getListOfParams() const
{
    ...
    params.push_back("test_distance_constant");
    return params;
}
...
bool FakeDepthCameraDriver_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    ...
    if (paramName =="test_distance_constant")
    {
        paramValue = std::to_string(m_test_distance_constant);
        return true;
    }
...
bool      FakeDepthCameraDriver_ParamsParser::parseParams(const yarp::os::Searchable & config)
{
    ...
    //Parser of parameter test_distance_constant
    {
        if (config.check("test_distance_constant"))
        {
            m_test_distance_constant = config.find("test_distance_constant").asFloat64();
            yCInfo(FakeDepthCameraDriverParamsCOMPONENT) << "Parameter 'test_distance_constant' using value:" << m_test_distance_constant;
        }
        else
        {
            yCInfo(FakeDepthCameraDriverParamsCOMPONENT) << "Parameter 'test_distance_constant' using DEFAULT value:" << m_test_distance_constant;
        }
        prop_check.unput("test_distance_constant");
    }
...
std::string      FakeDepthCameraDriver_ParamsParser::getDocumentationOfDeviceParams() const
{
    ...
    doc = doc + std::string("'test_distance_constant': if set != 0, it will set all the pixels of the generated depth to constant distance of x meters\n");
    doc = doc + std::string("\n");
    doc = doc + std::string("Here are some examples of invocation command with yarpdev, with all params:\n");
    doc = doc + " yarpdev --device fakeDepthCamera --rgb_h 480.0 --rgb_w 640.0 --dep_h 480.0 --dep_w 640.0 --accuracy 0.001 --rgb_Vfov 50.0 --rgb_Hfov 36.0 --dep_Vfov 50.0 --dep_Hfov 36.0 --dep_near 0.2 --dep_far 6.0 --test_distance_constant 2.0\n";
