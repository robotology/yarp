...
bool      FakeSerialPort_ParamsParser::parseParams(const yarp::os::Searchable & config)
{
    ...
    //Parser of parameter period
    {
        if (config.check("period"))
        {
            ...
            yCInfo(FakeSerialPortParamsCOMPONENT) << "Parameter 'period' using value:" << m_period;
        }
        else
        {
            yCInfo(FakeSerialPortParamsCOMPONENT) << "Parameter 'period' using DEFAULT value:" << m_period;
        }
...
std::string      FakeSerialPort_ParamsParser::getDocumentationOfDeviceParams() const
{
    ...
    doc = doc + " yarpdev --device FakeSerialPort --period 1.0\n";
    doc = doc + std::string("Using only mandatory params:\n");
    doc = doc + " yarpdev --device FakeSerialPort\n";
    doc = doc + std::string("=============================================\n\n");    return doc;
}
