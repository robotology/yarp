...
bool FakeSerialPort_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    ...
    {
        paramValue = std::string(1, m_line_terminator_char1);
        return true;
    }
    if (paramName =="line_terminator_char2")
    {
        paramValue = std::string(1, m_line_terminator_char2);
        return true;
    }
...
std::string FakeSerialPort_ParamsParser::getConfiguration() const
{
