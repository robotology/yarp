...
// Generated on: Tue Jul 28 23:33:16 2026
...
bool FakeMotionControl_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    ...
    if (paramName =="GENERAL::ampsToSensor")
    {
        std::ostringstream oss;
        oss << "( ";
        for (auto x : m_GENERAL_ampsToSensor)
        {
            oss << x << " ";
        }
        oss << " )";
    ...
    if (paramName =="GENERAL::fullscalePWM")
    {
        std::ostringstream oss;
        oss << "( ";
        for (auto x : m_GENERAL_fullscalePWM)
        {
            oss << x << " ";
        }
        oss << " )";
...
std::string FakeMotionControl_ParamsParser::getConfiguration() const
{
