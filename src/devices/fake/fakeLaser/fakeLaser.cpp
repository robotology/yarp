...
bool FakeLaser::open(yarp::os::Searchable& config)
{
    ...
    else if (m_test_mode == USE_MAPFILE)
    {
        ...
        else if (!m_localization_client.empty() ||
                 !m_localization_server.empty() ||
                 !m_localization_device.empty())
        {
            Property loc_options;
            std::string localization_client_name = m_localization_client;
            std::string localization_server_name = m_localization_server;
            std::string localization_device_name = m_localization_device;
