...
* | -             | rpc_test_port       | string | -     | /fakeLaser/rpc:i              | 0        | Full name of the rpc port on which user can send different test commands        | -                                                                                                     |
...
public:
    ...
    const std::string m_rpc_test_port_defaultValue = {"/fakeLaser/rpc:i"};
    ...
    std::string m_rpc_test_port = {"/fakeLaser/rpc:i"};
