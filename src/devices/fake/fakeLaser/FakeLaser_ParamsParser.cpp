...
// Generated on: Tue Jul 28 23:33:14 2026
...
std::vector<std::string> FakeLaser_ParamsParser::getListOfParams() const
{
    ...
    params.push_back("rpc_test_port");
...
bool FakeLaser_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    if (paramName =="test")
    {
        paramValue = m_test;
    ...
    if (paramName =="rpc_test_port")
    {
        paramValue = m_rpc_test_port;
        return true;
    }
...
std::string FakeLaser_ParamsParser::getConfiguration() const
{
...
bool      FakeLaser_ParamsParser::parseParams(const yarp::os::Searchable & config)
{
    ...
    //Parser of parameter rpc_test_port
    {
        if (config.check("rpc_test_port"))
        {
            m_rpc_test_port = config.find("rpc_test_port").asString();
            yCInfo(FakeLaserParamsCOMPONENT) << "Parameter 'rpc_test_port' using value:" << m_rpc_test_port;
        }
        else
        {
            yCInfo(FakeLaserParamsCOMPONENT) << "Parameter 'rpc_test_port' using DEFAULT value:" << m_rpc_test_port;
        }
        prop_check.unput("rpc_test_port");
    }
...
std::string      FakeLaser_ParamsParser::getDocumentationOfDeviceParams() const
{
    ...
    doc = doc + std::string("'rpc_test_port': Full name of the rpc port on which user can send different test commands\n");
    ...
    doc = doc + " yarpdev --device fakeLaser --test use_pattern --rpc_test_port /fakeLaser/rpc:i --localization_port /fakeLaser/location:i --localization_server /localizationServer --localization_client /fakeLaser/localizationClient --localization_device localization2DClient --MAP_MODE::map_file <optional_value> --MAP_MODE::map_context <optional_value> --clip_max 3.5 --clip_min 0.1 --GENERAL::period 0.02 --CONSTANT_MODE::const_distance 1\n";
