...
bool      FakeMotionControlMicro_ParamsParser::parseParams(const yarp::os::Searchable & config)
{
    ...
    //Parser of parameter period
    {
        if (config.check("period"))
        {
            ...
            yCInfo(FakeMotionControlMicroParamsCOMPONENT) << "Parameter 'period' using value:" << m_period;
        }
        else
        {
            yCInfo(FakeMotionControlMicroParamsCOMPONENT) << "Parameter 'period' using DEFAULT value:" << m_period;
        }
...
std::string      FakeMotionControlMicro_ParamsParser::getDocumentationOfDeviceParams() const
{
    ...
    doc = doc + " yarpdev --device FakeMotionControlMicro --period 1.0\n";
