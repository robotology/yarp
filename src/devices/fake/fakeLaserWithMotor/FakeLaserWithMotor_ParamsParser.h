...
* \code{.unparsed}
* yarpdev --device FakeLaserWithMotor --test use_pattern --localization_port /fakeLaser/location:i --localization_server /localizationServer --localization_client /fakeLaser/localizationClient --localization_device localization2DClient --map_file <optional_value> --map_context <optional_value> --clip_max 3.5 --clip_min 0.1
* \endcode
*
* \code{.unparsed}
...
{
public:
    FakeLaserWithMotor_ParamsParser() = default;
    ~FakeLaserWithMotor_ParamsParser() override = default;

public:
    const std::string m_device_type = {"FakeLaserWithMotor"};
