...
bool      FakeLaserWithMotor_ParamsParser::parseParams(const yarp::os::Searchable & config)
{
    ...
    //Parser of parameter map_file
    {
        if (config.check("map_file"))
        {
            ...
            yCInfo(FakeLaserWithMotorParamsCOMPONENT) << "Parameter 'map_file' using value:" << m_map_file;
        }
        else
        {
            yCInfo(FakeLaserWithMotorParamsCOMPONENT) << "Parameter 'map_file' using DEFAULT value:" << m_map_file;
        }
    ...
    //Parser of parameter map_context
    {
        if (config.check("map_context"))
        {
            ...
            yCInfo(FakeLaserWithMotorParamsCOMPONENT) << "Parameter 'map_context' using value:" << m_map_context;
        }
        else
        {
            yCInfo(FakeLaserWithMotorParamsCOMPONENT) << "Parameter 'map_context' using DEFAULT value:" << m_map_context;
        }
...
std::string      FakeLaserWithMotor_ParamsParser::getDocumentationOfDeviceParams() const
{
    ...
    doc = doc + " yarpdev --device FakeLaserWithMotor --test use_pattern --localization_port /fakeLaser/location:i --localization_server /localizationServer --localization_client /fakeLaser/localizationClient --localization_device localization2DClient --map_file <optional_value> --map_context <optional_value> --clip_max 3.5 --clip_min 0.1\n";
