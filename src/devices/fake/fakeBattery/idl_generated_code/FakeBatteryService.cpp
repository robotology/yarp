...
namespace
{
    YARP_LOG_COMPONENT(SERVICE_LOG_COMPONENT, "FakeBatteryService")
}

//FakeBatteryService_getRemoteProtocolVersion_helper declaration
class FakeBatteryService_getRemoteProtocolVersion_helper :
...
bool FakeBatteryService_getRemoteProtocolVersion_helper::write(yarp::os::ConnectionWriter& connection) const
{
...
bool FakeBatteryService_getRemoteProtocolVersion_helper ::read(yarp::os::ConnectionReader & connection)
 {
...
yarp::os::ApplicationNetworkProtocolVersion FakeBatteryService::getRemoteProtocolVersion()
 {
    if(!yarp().canWrite()) {
        yError(" Missing server method FakeBatteryService::getRemoteProtocolVersion");
    }
    FakeBatteryService_getRemoteProtocolVersion_helper helper{};
...
//ProtocolVersion, client side
bool FakeBatteryService::checkProtocolVersion()
 {
...
yarp::os::ApplicationNetworkProtocolVersion FakeBatteryService::getLocalProtocolVersion()
{
