...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_POSE6D_H
#define YARP_THRIFT_GENERATOR_STRUCT_POSE6D_H
...
public:
    ...
    typedef yarp::os::idl::Unwrapped<Pose6D> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_POSE6D_H
