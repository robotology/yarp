...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_VEC2DOFSIZETDATA_H
#define YARP_THRIFT_GENERATOR_STRUCT_VEC2DOFSIZETDATA_H
...
class YARP_sig_API Vec2DOfSizetData :
...
public:
    ...
    // Default constructor
    Vec2DOfSizetData() = default;

    // Constructor with field values
    Vec2DOfSizetData(const size_t x,
                     const size_t y);
    ...
    typedef yarp::os::idl::Unwrapped<Vec2DOfSizetData> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_VEC2DOFSIZETDATA_H
