...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_VEC2DOFDOUBLEDATA_H
#define YARP_THRIFT_GENERATOR_STRUCT_VEC2DOFDOUBLEDATA_H
...
class YARP_sig_API Vec2DOfDoubleData :
...
public:
    ...
    // Default constructor
    Vec2DOfDoubleData() = default;

    // Constructor with field values
    Vec2DOfDoubleData(const double x,
                      const double y);
    ...
    typedef yarp::os::idl::Unwrapped<Vec2DOfDoubleData> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_VEC2DOFDOUBLEDATA_H
