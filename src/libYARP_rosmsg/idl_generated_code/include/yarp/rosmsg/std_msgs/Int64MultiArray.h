...
// Generated from the following "std_msgs/Int64MultiArray" msg definition:
...
#ifndef YARP_ROSMSG_std_msgs_Int64MultiArray_h
#define YARP_ROSMSG_std_msgs_Int64MultiArray_h
...
class Int64MultiArray : public yarp::os::idl::WirePortable
{
public:
    yarp::rosmsg::std_msgs::MultiArrayLayout layout;
    std::vector<yarp::os::NetInt64> data;
    ...
    bool readBare(yarp::os::ConnectionReader& connection) override
    {
        ...
        data.resize(len);
        if (len > 0 && !connection.expectBlock((char*)&data[0], sizeof(yarp::os::NetInt64)*len)) {
            return false;
        }
    ...
    bool readBottle(yarp::os::ConnectionReader& connection) override
    {
        ...
        data.resize(len);
        for (int i=0; i<len; i++) {
            data[i] = (yarp::os::NetInt64)connection.expectInt();
        }
    ...
    bool writeBare(yarp::os::ConnectionWriter& connection) override
    {
        ...
        if (data.size()>0) {
            connection.appendExternalBlock((char*)&data[0], sizeof(yarp::os::NetInt64)*data.size());
        }
...
") + yarp::rosmsg::std_msgs::MultiArrayLayout::typeText();
    ...
    yarp::os::Type getType() override
    {
        ...
        typ.addProperty("md5sum", yarp::os::Value("ab1241968efe29bbec0698b18dbab07d"));
...
#endif // YARP_ROSMSG_std_msgs_Int64MultiArray_h
