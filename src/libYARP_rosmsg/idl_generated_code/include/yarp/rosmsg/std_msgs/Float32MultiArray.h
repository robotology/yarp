...
// Generated from the following "std_msgs/Float32MultiArray" msg definition:
...
#ifndef YARP_ROSMSG_std_msgs_Float32MultiArray_h
#define YARP_ROSMSG_std_msgs_Float32MultiArray_h
...
class Float32MultiArray : public yarp::os::idl::WirePortable
{
public:
    yarp::rosmsg::std_msgs::MultiArrayLayout layout;
    std::vector<yarp::os::NetFloat32> data;
    ...
    bool readBare(yarp::os::ConnectionReader& connection) override
    {
        ...
        data.resize(len);
        if (len > 0 && !connection.expectBlock((char*)&data[0], sizeof(yarp::os::NetFloat32)*len)) {
            return false;
        }
    ...
    bool readBottle(yarp::os::ConnectionReader& connection) override
    {
        ...
        data.resize(len);
        for (int i=0; i<len; i++) {
            data[i] = (yarp::os::NetFloat32)connection.expectDouble();
        }
    ...
    bool writeBare(yarp::os::ConnectionWriter& connection) override
    {
        ...
        if (data.size()>0) {
            connection.appendExternalBlock((char*)&data[0], sizeof(yarp::os::NetFloat32)*data.size());
        }
...
") + yarp::rosmsg::std_msgs::MultiArrayLayout::typeText();
    ...
    yarp::os::Type getType() override
    {
        ...
        typ.addProperty("md5sum", yarp::os::Value("ae03656041577ad080b1a867c6de3f2b"));
...
#endif // YARP_ROSMSG_std_msgs_Float32MultiArray_h
