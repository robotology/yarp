...
// Generated from the following "std_msgs/Int16MultiArray" msg definition:
...
#ifndef YARP_ROSMSG_std_msgs_Int16MultiArray_h
#define YARP_ROSMSG_std_msgs_Int16MultiArray_h
...
class Int16MultiArray : public yarp::os::idl::WirePortable
{
public:
    yarp::rosmsg::std_msgs::MultiArrayLayout layout;
    std::vector<yarp::os::NetInt16> data;
    ...
    bool readBare(yarp::os::ConnectionReader& connection) override
    {
        ...
        data.resize(len);
        if (len > 0 && !connection.expectBlock((char*)&data[0], sizeof(yarp::os::NetInt16)*len)) {
            return false;
        }
    ...
    bool readBottle(yarp::os::ConnectionReader& connection) override
    {
        ...
        data.resize(len);
        for (int i=0; i<len; i++) {
            data[i] = (yarp::os::NetInt16)connection.expectInt();
        }
    ...
    bool writeBare(yarp::os::ConnectionWriter& connection) override
    {
        ...
        if (data.size()>0) {
            connection.appendExternalBlock((char*)&data[0], sizeof(yarp::os::NetInt16)*data.size());
        }
...
") + yarp::rosmsg::std_msgs::MultiArrayLayout::typeText();
    ...
    yarp::os::Type getType() override
    {
        ...
        typ.addProperty("md5sum", yarp::os::Value("ecdd9d3fbfdd3614896f2dfd2f5a7a55"));
...
#endif // YARP_ROSMSG_std_msgs_Int16MultiArray_h
