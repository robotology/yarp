...
// Generated on: Tue Jul 28 23:41:14 2026
...
bool TestDeviceWGP1_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    ...
    {
        paramValue = std::string(1, m_param_5);
        return true;
    }
