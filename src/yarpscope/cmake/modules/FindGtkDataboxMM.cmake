    ...
    if(PKG_CONFIG_FOUND)
        if(GtkDataboxMM_FIND_VERSION)
            if(GtkDataboxMM_FIND_VERSION_EXACT)
                pkg_check_modules(PC_GTKDATABOXMM
                                  QUIET
                                  gtkdataboxmm-0.0=${GTKDATABOXMM_FIND_VERSION})
...
set(GTKDATABOXMM_INCLUDE_DIRS ${PC_GTKDATABOXMM_INCLUDE_DIRS})
set(GTKDATABOXMM_LIBRARY_DIRS ${PC_GTKDATABOXMM_LIBRARY_DIRS})
set(GTKDATABOXMM_LIBRARIES ${PC_GTKDATABOXMM_LIBRARIES})

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(GtkDataboxMM DEFAULT_MSG
                                  GTKDATABOXMM_LIBRARIES GTKDATABOXMM_INCLUDE_DIRS)

mark_as_advanced(GTKDATABOXMM_LIBRARIES
