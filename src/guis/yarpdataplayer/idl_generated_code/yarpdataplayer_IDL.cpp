...
namespace
{
    YARP_LOG_COMPONENT(SERVICE_LOG_COMPONENT, "yarpdataplayer_IDL")
}

//yarpdataplayer_IDL_getRemoteProtocolVersion_helper declaration
class yarpdataplayer_IDL_getRemoteProtocolVersion_helper :
...
bool yarpdataplayer_IDL_getRemoteProtocolVersion_helper::write(yarp::os::ConnectionWriter& connection) const
{
...
bool yarpdataplayer_IDL_getRemoteProtocolVersion_helper ::read(yarp::os::ConnectionReader & connection)
 {
...
yarp::os::ApplicationNetworkProtocolVersion yarpdataplayer_IDL::getRemoteProtocolVersion()
 {
    if(!yarp().canWrite()) {
        yError(" Missing server method yarpdataplayer_IDL::getRemoteProtocolVersion");
    }
    yarpdataplayer_IDL_getRemoteProtocolVersion_helper helper{};
