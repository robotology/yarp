...
class yarpdataplayer_IDL_setFrame :
        public yarp::os::Portable
{
public:
    std::string name;
...
class yarpdataplayer_IDL_getFrame :
        public yarp::os::Portable
{
public:
    std::string name;
...
class yarpdataplayer_IDL_pause :
        public yarp::os::Portable
{
public:
    bool _return;
